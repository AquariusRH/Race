...
def top(method_odds_df, method_investment_df, method):
    ...
    last_row_odds_df['Initial_Rank'] = last_row_odds_df.apply(lambda row: f"{row['Initial_Rank']} ({row['Change_of_Rank']})", axis=1).astype(str)
    ...
    last_row_odds_df['Previous_Rank'] = last_row_odds_df.apply(lambda row: f"{row['Previous_Rank']} ({row['Change_of_Previous_Rank']})", axis=1).astype(str)
